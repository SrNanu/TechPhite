...
const offerings = [
  {
    ...
    description: 'Una landing page moderna y profesional donde tus clientes encuentran tu trayectoria, servicios y toda la información que necesitan para confiar en vos.',
    icon: MonitorSmartphone,
  },
  {
    title: 'Llamados a la Acción Efectivos',
    description: 'Formularios y botones de WhatsApp estratégicamente ubicados para que los visitantes soliciten presupuestos o se pongan en contacto de forma rápida.',
    icon: FileInput,
  },
  {
    title: 'Tu Marca al Máximo Nivel',
    description: 'Adaptamos los colores, tipografías y el estilo visual para que coincida perfectamente con la identidad de tu negocio.',
    icon: Palette,
  },
];

export default function LandingPageOfferings() {
  return (
    <section className="py-24 bg-slate-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Con <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-500">TechPhite</span>, esto cambia
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
