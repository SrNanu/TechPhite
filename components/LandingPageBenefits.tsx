...
const problems = [
  {
    ...
    description: 'Cuando alguien busca tus servicios y no encontrás con una web profesional, ese prospecto se lo lleva la competencia que sí la tiene.',
    icon: UserX,
  },
  {
    title: 'Clientes que Dudan de tu Solidez',
    description: 'Sin un sitio web propio, tus prospectos te perciben como informal. Un dominio profesional genera más confianza que un simple perfil de red social.',
    icon: ShieldAlert,
  },
  {
    title: 'Alta Competencia ya Digitalizada',
    description: 'Otros negocios ya tienen web, SEO y formularios rápidos. Cada día que pasa sin tu presencia digital, perdés terreno frente a quienes ya se digitalizaron.',
    icon: TrendingDown,
  },
];
    ...
    <section className="py-24 bg-slate-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            ¿Por qué tener tu propia landing page?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
