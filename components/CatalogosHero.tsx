        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-orange-500/30 bg-orange-500/10 text-orange-400 text-sm font-medium mb-6">
              ...
              Para Comercios, Mayoristas y Distribuidores
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-white">
              Tu negocio abierto 24/7. <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-rose-500">
                Catálogos online profesionales.
              </span>
            </h1>
            
            <p className="text-xl text-slate-400 mb-10 leading-relaxed">
              Olvidate de mandar PDFs pesados por WhatsApp. Exhibí tus productos, 
              recibí pedidos y actualizá precios en tiempo real.
            </p>
