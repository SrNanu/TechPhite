        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-slate-400 mb-10 leading-relaxed">
              Destacate en tu sector. Captá más clientes, automatizá consultas y 
              dale a tu negocio la imagen profesional que exige el mundo de hoy.
            </p>
          ...
          >
            ...
            <div className="bg-slate-900/50 p-3 rounded-[2rem] border border-white/10 shadow-2xl backdrop-blur-sm">
              <div className="rounded-[1.5rem] overflow-hidden relative">
                ...
                <Image
                  src="/seguros.webp"
                  alt="Mockup de una landing page"
                  width={1200}
                  height={800}
