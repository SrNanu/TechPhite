...
export default function SegurosHero() {
  ...
  return (
    <section className="relative min-h-screen pt-32 pb-20 flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(16,185,129,0.08),transparent_50%)]"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="max-w-2xl"
          >
            <div className="inline-block px-4 py-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-sm font-medium mb-6">
              Para Productores Asesores de Seguros
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-white">
              Tu productora de seguros, con la{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-500">
                imagen digital que merece.
              </span>
            </h1>
            
            <p className="text-xl text-gray-400 mb-10 leading-relaxed">
              Páginas profesionales para productores que quieren transmitir confianza y captar más clientes online.
            </p>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-emerald-500/20 to-transparent opacity-50 rounded-lg blur-xl -z-10"></div>
